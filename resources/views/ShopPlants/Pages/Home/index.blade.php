                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center">
                                <h2>Reconnect with Nature Through the Power of Ayurvedic Plants</h2>
                                <p>At Ayuresse Shop, we bring you a diverse selection of Ayurvedic plants known for their
                                    healing properties, holistic benefits, and deep-rooted connection to nature.
                                Experience the purity of nature and let Ayurvedic plants nourish your mind, body, and
                                    soul.</p>
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2>Discover the Healing Power of Ayurvedic Plants</h2>
                                <p>Explore nature’s finest remedies with Ayuresse Shop. Our carefully curated collection of
                                    Ayurvedic plants nurtures wellness, bringing balance and vitality to your life.</p>
                                <div class="welcome-btn-group">
                                    <a href="{{ route('ShopProduct.all') }}" class="btn alazea-btn mr-30">SHOP NOW</a>
