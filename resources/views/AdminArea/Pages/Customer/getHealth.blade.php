...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Get Health Data Table</h3>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Get Health Records</h4>
                <div class="row">
                    <div class="col-12">
...
{{-- Delete Modal --}}
<div class="modal fade" id="deleteGetHealthModal" tabindex="-1" role="dialog" aria-labelledby="deleteGetHealthLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" style="max-height: 300px;">
            ...
            <div class="modal-footer" style="padding: 10px;">
                <form id="deleteGalleryForm" action="{{ route('CustomerManagement.getHealthDelete') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" id="getHealthId">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="replyModalLabel">Reply to Get Health</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="replyForm" method="POST" action="{{ route('ContactUs.getHealthSendReply') }}">
                @csrf
...
@push('js')
    <script>
        function confirmDelete(getHealthId) {
            // Set the student ID in the hidden input field of the delete modal
            document.getElementById('getHealthId').value = getHealthId;

            // Show the delete modal
            $('#deleteGetHealthModal').modal('show');
        }
    </script>
    <script>
