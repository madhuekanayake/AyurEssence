...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Product Data Table</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='{{ route('ProductManagement.productAll') }}'">
...
<div class="modal-dialog modal-md" role="document">
    <div class="modal-content" style="max-height: 300px;">
        ...
        <div class="modal-footer" style="padding: 10px;">
            <form id="deleteImageForm" action="{{ route('ProductManagement.viewProductImageDelete') }}"
                method="POST">
                @csrf
                <input type="hidden" name="id" id="productImageId">
...
@push('js')
    <script>
        ...
        function confirmDelete(productImageId) {
