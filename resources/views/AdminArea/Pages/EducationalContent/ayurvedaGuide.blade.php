...
@section('Admincontainer')
                                        ...
                                        @foreach ($ayurveda_guides as $guide)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($guide->image)
                                                        <img src="{{ asset('storage/' . $guide->image) }}"
                                                            alt="Ayurveda Guide Image" width="100">
                                                    @else
                                                        No Image
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-link text-primary p-0 mr-2"
                                                        data-toggle="modal" data-target="#viewAyurvedicGuideModal"
                                                        onclick="viewGuide(
                                                        '{{ $guide->id }}',
                                                        '{{ $guide->title }}',
                                                        '{{ $guide->information }}',
    ...
    {{-- Add Modal --}}
    <div class="modal fade" id="addAyurvedicGuideModal" tabindex="-1" role="dialog"
        aria-labelledby="addAyurvedicGuideLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('EducationalContent.ayurvedaGuideAdd') }}" method="POST"
                        enctype="multipart/form-data" id="addAyurvedaGuideForm">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="title">Guide Title <span style="color: red;">*</span></label>
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Guide Title" required pattern=".*\S.*"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Guide Description"
                                    required></textarea>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="editAyurvedicGuideModal" tabindex="-1" role="dialog"
        aria-labelledby="editAyurvedicGuideLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{ route('EducationalContent.ayurvedaGuideUpdate') }}" method="POST"
                        enctype="multipart/form-data" id="editAyurvedaGuideForm">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="edit_description" name="description" rows="3"
                                    placeholder="Guide Description" required></textarea>
                            </div>
                        </div>
    ...
    {{-- Delete Modal --}}
    <div class="modal fade" id="deleteAyurvedaGuideModal" tabindex="-1" role="dialog"
        aria-labelledby="deleteAyurvedaGuideLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content" style="max-height: 300px;">
                ...
                <div class="modal-footer" style="padding: 10px;">
                    <form id="deleteGalleryForm" action="{{ route('EducationalContent.ayurvedaGuideDelete') }}"
                        method="POST">
                        @csrf
    ...
    <div class="modal fade" id="viewAyurvedicGuideModal" tabindex="-1" role="dialog"
        aria-labelledby="viewAyurvedicGuideLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form id="viewAyurvedaGuideForm">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="view_title" name="title"
                                    placeholder="Guide Title" readonly>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label for="view_image">File Upload <span style="color: red;">*</span></label>
                                <input type="file" class="form-control" id="view_image" name="view_image" required>
                            </div>

                            <div class="form-group col-md-12">
                                <label for="view_description">Description</label>
                                <textarea class="form-control" id="view_description" name="description" rows="3"
                                    placeholder="Guide Description" readonly></textarea>
                            </div>
                        </div>
...
@push('js')
    <script>
            ...
            $('#editAyurvedicGuideModal').on('shown.bs.modal', function() {
                ...
                if (!quillEdit) {
                    ...
                    quillEdit.on('text-change', function() {
                        document.getElementById('edit_information').value = quillEdit.root
                        .innerHTML;
                    });
                }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function viewGuide(id, title, information, image, description) {
    ...
    <script>
        function editGuide(id, title, information, image, description) {
