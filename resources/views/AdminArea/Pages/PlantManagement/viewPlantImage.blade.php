            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='{{ route('PlantManagement.plantAll') }}'">
                                    ...
                                    @foreach ($plant_images as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @php
                                                $hasActive = $plant_images->contains('isPrimary', 1);
                                            @endphp
...
<div class="modal-dialog modal-md" role="document">
    <div class="modal-content" style="max-height: 300px;">
        ...
        <div class="modal-footer" style="padding: 10px;">
            <form id="deleteImageForm" action="{{ route('PlantManagement.viewPlantImageDelete') }}"
                method="POST">
                @csrf
                <input type="hidden" name="id" id="plantImageId">
...
@push('js')
    <script>
        ...
        function confirmDelete(plantImageId) {
            // Set the student ID in the hidden input field of the delete modal
            document.getElementById('plantImageId').value = plantImageId;
