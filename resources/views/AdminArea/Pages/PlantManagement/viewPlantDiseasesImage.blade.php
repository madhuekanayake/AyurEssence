...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Plant Diseases Table</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='{{ route('PlantManagement.plantDiseasesAll') }}'">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Plant Diseases Records</h4>
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="order-listing" class="table">
                                ...
                                <tbody>
                                    @foreach ($plant_diseases_images as $item)
                                        <tr>
...
<div class="modal-dialog modal-md" role="document">
    <div class="modal-content" style="max-height: 300px;">
        ...
        <div class="modal-footer" style="padding: 10px;">
            <form id="deleteImageForm" action="{{ route('PlantManagement.viewPlantDiseasesImageDelete') }}"
                method="POST">
                @csrf
