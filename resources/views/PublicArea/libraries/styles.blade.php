...
<link rel="shortcut icon" href="{{ 'PublicArea/images/favicon.png' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/bootstrap.min.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/animate.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/all.min.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/fontello.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/flaticon.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/themify-icons.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/font-awesome.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/aos.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/slick.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/prettyPhoto.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/samarkannormal.css' }}">
<link rel="stylesheet" type="text/css" href="{{ 'PublicArea/css/shortcodes.css' }}">
