                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail">
                                    <img width="303" height="300" class="img-fluid" src="{{ asset('PublicArea/images/blog/blog-02.jpg') }}" alt="">
                                </div>
                                <!-- featured-content -->
                                <div class="featured-content">
                                    <div class="featured-content-inner">
                                        <div class="post-header">
                                            ...
                                            <div class="post-title featured-title">
                                                <h3><a href="blog-single.html">Best lawyer services HTML template listed as multilingual</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- featured-content end -->
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail">
                                    <img width="303" height="300" class="img-fluid" src="{{ asset('PublicArea/images/blog/blog-04.jpg') }}" alt="">
                                </div>
                                <!-- featured-content -->
                                <div class="featured-content">
                                    <div class="featured-content-inner">
                                        <div class="post-header">
                                            ...
                                            <div class="post-title featured-title">
                                                <h3><a href="blog-single.html">5 trendy template for architecture & interior service</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- featured-content end -->
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail">
                                    <img width="303" height="300" class="img-fluid" src="{{ asset('PublicArea/images/blog/blog-05.jpg') }}" alt="">
                                </div>
                                <!-- featured-content -->
                                <div class="featured-content">
                                    <div class="featured-content-inner">
                                        <div class="post-header">
                                            ...
                                            <div class="post-title featured-title">
                                                <h3><a href="blog-single.html">Get the best  templates for ayurvedic medical service</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- featured-content end -->
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail">
                                    <img width="303" height="300" class="img-fluid" src="{{ asset('PublicArea/images/blog/blog-06.jpg') }}" alt="">
                                </div>
                                <!-- featured-content -->
                                <div class="featured-content">
                                    <div class="featured-content-inner">
                                        <div class="post-header">
                                            ...
                                            <div class="post-title featured-title">
                                                <h3><a href="blog-single.html">Unique templates for fitness & food category</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- featured-content end -->
                                </div>
