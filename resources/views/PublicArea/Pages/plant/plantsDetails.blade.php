                    ...
                    <div class="col-lg-12">
                        <div class="prt-page-title-row-heading">
                            <div class="page-title-heading">
                                <h2 class="title">Plant Details</h2>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="plant-info">
                                ...
                                <p><strong>Medical Uses:</strong> {{ $plant->medicalUses }}</p>
                                <p><strong>Traditional Uses:</strong> {{ $plant->traditionalUses }}</p>
                                <p><strong>Modern Uses:</strong> {{ $plant->modernUses }}</p>
                                <p><strong>Toxicity Information:</strong> {{ $plant->toxicityInformation }}</p>
                                <p><strong>Associated Diseases:</strong> {{ $plant->associatedDiseases }}</p>
