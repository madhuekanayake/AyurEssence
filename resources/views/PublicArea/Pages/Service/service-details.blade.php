    ...
    <div class="page">
        ...
        <div class="site-main">
                                ...
                                <div class="row">
                                    <div class="col-lg-11 col-md-12 m-auto">
                                        <div class="aboutservice-content">
                                            ...
                                            <p class="desc">Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit. adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="">
                               ...
                               <ul class="prt-list prt-list-style-icon-03">
                                    <li class="prt-list-li-content">Sed do eiusmod tempor incididunt ut labore et dolore magna </li>
                                    <li class="prt-list-li-content">Ut enim ad minim veniam, quis nostrud exercitation</li>
                                    <li class="prt-list-li-content">Laboris nisi ut aliquip ex ea commodo consequat duis  </li>
                                    <li class="prt-list-li-content">dolor in reprehenderit in voluptate velit esse cillum dolore</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            ...
                            <div class="prt_single_image-wrapper text-center res-1199-mt-30 faderight-anim">
                                <img width="635" height="500" class="img-fluid border-rad_10" src="images/single-img-08.png" alt="image">
                            </div>
            ...
            <section class="prt-row service-section02 clearfix ml-15 mr-15 res-991-ml-0 res-991-mr-0">
                <div class="container-fluid">
                    <div class="row row-equal-height slick_slider" data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "arrows":false, "dots":false, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":1400,"settings":{"slidesToShow": 3}},{"breakpoint":980,"settings":{"slidesToShow": 2}},{"breakpoint":656,"settings":{"slidesToShow": 1}}]}'>
            ...
            <section class="prt-row padding_top_zero-section pricing-plan-section prt-pricingbox-style1 animation clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <!-- section title -->
                            <div class="section-title">
                                ...
                                <div class="title-desc pricing-desc">
                                    <p><img width="24" height="24" class="img-fluid" src="images/icon-05.svg" alt="image"> Explore competitive pricing and flexible plans <a class="prt-btn btn-inline prt-btn-size-md prt-btn-color-darkcolor underline p-0" href="contact-us.html">Make appointment</a></p>
                                </div>    
                            </div><!-- section title end -->
                        </div>
                        <div class="col-lg-5">
                            <div class="title-desc">
                                <p>Discover transparent pricing and flexible plans to meet diverse needs. From budget-friendly options to comprehensive packages, we cater to every requirement</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="featured-pricing-content">
                                        <div class="prt-p_table-body">
                                            ...
                                            <div class="prt-p_table-amount">
                                                <span class="cur_symbol"></span>$45<span class="pac_frequency">/ mo</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="prt-pricing-btn">
                                            <a class="prt-btn prt-btn-size-md prt-btn-shape-round  prt-btn-style-border prt-btn-color-darkcolor" href="contact-us.html">Buy Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="featured-box-info">
                                    <div class="featured-pricing-content">
                                        <div class="prt-p_table-body">
                                            ...
                                            <div class="prt-p_table-amount">
                                                <span class="cur_symbol"></span>$59<span class="pac_frequency">/ mo</span>
                                            </div>
                                        </div>
                                        <ul class="prt-p_table-features">
                                ...
                                <div class="featured-box-info">
                                    <div class="featured-pricing-content">
                                        <div class="prt-p_table-body">
                                            ...
                                            <div class="prt-p_table-amount">
                                                <span class="cur_symbol"></span>$84<span class="pac_frequency">/ mo</span>
                                            </div>
                                        </div>
                                        <ul class="prt-p_table-features">
