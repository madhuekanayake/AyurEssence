                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="team-details-image-wrapper">
                                            <img width="474" height="445" class="img-fluid team-details-image" src="images/team-member/team-img01.png" alt="image">
                                        </div>
                                    </div>
                                    <div class="col-lg-7 align-self-center res-991-mt-30">
                                        <div class="team-details-info">
                                            ...
                                            <div class="team-details-info-desc">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmodeincididunt ut labore et dolore magna aliqua ipsum  dolor suspendisse ultrices </p>
                                            </div>
                                            <div class="team-details-list">
                                                <ul class="prt-list">
                                                    <li><span>Experience :</span>25 years</li>
                                                    <li><span>Email address :</span><a href="mailto:info@example.com">infosupport@.example.com</a></li>
                                                    <li><span>Phone number :</span><a href="tel:1234567890">000+ 123 456 7890</a></li>
                                                    <li><span>Address :</span>048 Winfield Forge,london,Louisiana</li>
                                                </ul>
                                            </div>
                                            <div class="team-details-social">
                                                 <ul class="social-icons">
                                                    <li><a href="https://www.facebook.com/themetechMount18" rel="noopener" aria-label="facebook"><i class="icon-facebook"></i></a></li>
                                                    <li><a href="https://twitter.com/themetechmount" rel="noopener" aria-label="twitter"><i class="icon-twitter"></i></a></li>
                                                    <li><a href="https://www.instagram.com/preyan_technosys/" rel="noopener" aria-label="instagram"><i class="icon-instagram"></i></a></li>
                                                    <li><a href="#" rel="noopener" aria-label="youtube"><i class="icon-youtube"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content-tab">
                                        ...
                                        <div class="content-inner active">
                                            <ul class="prt-list style4 pb-20">
                                                <li class="prt-list-item"><div></div><span>Bachelor of science in biology, university of california, los a</span></li>
                                                <li class="prt-list-item"><div></div><span>Doctor of medicine, university of california, san francisco (UC</span></li>
                                                <li class="prt-list-item"><div></div><span>Ophthalmology residency, jules stein eye institute, UCLA, 2015</span></li>
                                            </ul>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod temporincididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risuscommodo viverra maecenas accumsan lacus vel facilisis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel.</p>
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempoincididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risucommodo viverra maecenas accumsan lacus vel facilisis ipsum suspendisse</p>
                        ...
                        <div class="col-lg-5">
                            <div class="time-shedule-block pl-80 res-991-pl-0 res-991-mt-30">
                                ...
                                <ul class="prt-list style2">
                                    <li class="prt-list-item"><label>Monday:</label><span>09:00am - 19:00pm</span></li>
                                    <li class="prt-list-item"><label>Tuesday:</label><span>09:00am - 19:00pm</span></li>
                                    <li class="prt-list-item"><label>Wednesday:</label><span>09:00am - 19:00pm</span></li>
                                    <li class="prt-list-item"><label>Tuesday:</label><span>09:00am - 19:00pm</span></li>
                                    <li class="prt-list-item"><label>Friday:</label><span>09:00am - 19:00pm</span></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="team-details-form-block">
                                ...
                                <form class="wrap-form message_form">
                                    <div class="d-flex flex-wrap">
                                        <div class="message-form-item">
                                            <span class="text-input">
                                                <label for="message_name">Hello, my name is</label>
                                                <input id="message_name" type="text" name="Name" value="" placeholder="Type name here">
                                            </span>
                                        </div>
                                        <div class="message-form-item">
                                            <span class="text-input">
                                                <label for="message_email">my email id</label>
                                                <input id="message_email" type="text" name="Email" value="" placeholder="Type email id here">
                                            </span>
                                        </div>
                                        <div class="message-form-item">
                                            <span class="text-input">
                                                <label for="message_number">and get in touch with me on</label>
                                                <input id="message_number" type="text" name="Time" value="" placeholder="Type number here">
                                            </span>
                                        </div>
                                        <div class="message-form-item">
                                            <span class="text-input">
                                                <label for="message_select">and I’m looking for</label>
                                                <select id="message_select" class="form-select message-select" aria-label="Default select" required="">
                                        ...
                                        <div class="message-form-item style2">
                                            <button type="submit" class="prt-btn prt-btn-size-md prt-btn-shape-round prt-btn-style-fill prt-btn-color-darkcolor">Send message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
